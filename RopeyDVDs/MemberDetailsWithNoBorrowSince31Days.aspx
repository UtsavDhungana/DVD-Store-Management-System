<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="MemberDetailsWithNoBorrowSince31Days.aspx.cs" Inherits="RopeyDVDs.MemberDetailsWithNoBorrowSince31Days" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container mt-2 mb-3">
        <div class="card shadow p-2">
            <div class="card-body">
                <center>
                    <h2 style="color: #1E90FF;">Details of the latest borrowed DVD before 31 days.</h2>
                </center>
            </div>
            <div class="card-body">
                <div class="row">
                                                ...
                                                <div class="col-lg-10">
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-12">
                                                            ...
                                                            <asp:Label ID="Label5" runat="server" Font-Bold="True" Text='<%# Eval("MemberAddress") %>'></asp:Label>
                                                        </div>
                                                    </div>
                                                    <div class="row mt-2">
                                                        <div class="col-12">
                                                            <span>Loaned Date - </span>
                                                            <asp:Label ID="Label2" runat="server" Font-Bold="True" Text='<%# Eval("RecentDateOut") %>'></asp:Label>
                                                            &nbsp;| <span><span>&nbsp;</span>Days Since Last Loan - </span>
